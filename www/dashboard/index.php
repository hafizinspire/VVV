...
<div class="container-fluid">
		...
		<div class="col-sm-4 col-md-3 sidebar">
			...
			<p class="sidebar-title">Credentials</p>
			<ul class="nav">
				<li><strong>Database Username:</strong> wp</li>
				<li><strong>Database Password:</strong> wp</li>
				<li><strong>WordPress Username:</strong> admin</li>
				<li><strong>Wordpress Password:</strong> password</li>
				<li><strong>MySQL User:</strong> root</li>
				<li><strong>MySQL Pass:</strong> root</li>
			</ul>
		</div>
